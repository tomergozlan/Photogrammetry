...
def main():
    ...
    select_100_distinct_frames(video_path_1, output_folder_1, overlap_threshold_1)
    ...
    select_100_distinct_frames(video_path_2, output_folder_2, overlap_threshold_2)
